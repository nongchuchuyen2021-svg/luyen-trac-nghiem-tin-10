...
const questions: Question[] = [
  {
    ...
    options: [
      "Dãy các kí tự đặt trong cặp nháy đơn hoặc nháy kép",
      "Dãy các số nguyên",
      "Một kiểu dữ liệu chỉ chứa chữ cái",
      "Tên khác của danh sách",
    ],
    answer: 0,
  ...
  },
  {
    ...
    options: [
      "Không thể gán lại từng kí tự kiểu s[0] = \"A\"",
      "Không thể tạo xâu mới",
      "Không in được xâu",
      "Không so sánh được hai xâu",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "True — so sánh theo thứ tự bảng mã từng kí tự, 'a' đứng trước 'b'",
      "False — xâu dài hơn thì lớn hơn",
      "Báo lỗi — không so sánh được xâu",
      "True — vì 'an' có 2 kí tự",
    ],
    answer: 0,
    explain:
