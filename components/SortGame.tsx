        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <div
            className={`flex items-center justify-center gap-2 rounded-2xl border-2 border-dashed py-4 font-display text-sm font-semibold transition ${
              leanLeft ? "border-tomato bg-tomato/10 text-tomato-deep scale-[1.03]" : "border-ink/10 text-ink-soft"
            }`}
          >
          ...
          <div
            className={`flex items-center justify-center gap-2 rounded-2xl border-2 border-dashed py-4 font-display text-sm font-semibold transition ${
              leanRight ? "border-mint bg-mint/10 text-mint-deep scale-[1.03]" : "border-ink/10 text-ink-soft"
            }`}
          >
        ...
        {!answered ? (
          <div className="mt-5 grid grid-cols-2 gap-3">
            <button
              ...
              className="rounded-2xl border-2 border-tomato/30 bg-tomato/5 py-3 font-display font-semibold text-tomato-deep transition hover:bg-tomato/10"
            >
              {game.noMatchEmoji} {game.noMatchLabel}
            </button>
            <button
              onClick={() => commit(true)}
              className="rounded-2xl border-2 border-mint/30 bg-mint/5 py-3 font-display font-semibold text-mint-deep transition hover:bg-mint/10"
            >
